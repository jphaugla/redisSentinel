package com.redis.jedispring.service;
...
import java.util.*;
import com.redis.jedispring.repository.TickerRepository;
...
public class RediSearchService {
    ...
    public String createTicker(Ticker ticker) throws JsonProcessingException {
        log.info("starting redisearch.createTicker");
        String return_val = "";
        return_val = tickerRepository.create(ticker);
        log.info("return from redisearch.createTicker " + return_val);
        return return_val;
    }
